...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/Midsummer cat.flac';
let bgmvolume = 0;
let bgm;
...
const AUDIO_DETAIL = [
	...
	},
	{
		time: 22000,
		count: 3,
		startTimes: [500, 12500, 15500],
		dialog: {
			Japanese: [
				"……不思議ですね。こういうことはしちゃいけないって、気を張ってなきゃって、ずっと思ってたはずなんですが……。",
				"先生と一緒にいると……。",
				"なんだか、気が抜けちゃうって言うか……。"
			],
			English: [
				...
				"I just can't help but relax."
			],
			Chinese: [
				"真不可思议呢，明明不能做这样的事，明明必须要振作起来的，明明一直是这样想的……",
				"和老师在一起就……",
				"总感觉，就会放松下来……"
			]
		}
